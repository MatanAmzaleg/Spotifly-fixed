...
export const SongBar = ({ song, i, artistId, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className={`song-bar-sec w-full flex flex-row items-center hover:bg-[#333746] ${activeSong?.title === song?.title ? 'bg-[#003746 ]' : 'bg-transparent'} py-2 p-4 rounded-lg cursor-pointer mb-2`}>
